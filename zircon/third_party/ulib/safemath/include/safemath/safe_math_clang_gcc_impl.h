...
#include <safemath/safe_math_arm_impl.h>  // IWYU pragma: export
#define SAFEMATH_HAS_ASSEMBLER_SAFE_MATH (1)
#else
#define SAFEMATH_HAS_ASSEMBLER_SAFE_MATH (0)
#endif
...
// safe math routines.
#if !SAFEMATH_HAS_ASSEMBLER_SAFE_MATH
...
#endif  // SAFEMATH_HAS_ASSEMBLER_SAFE_MATH
#undef SAFEMATH_HAS_ASSEMBLER_SAFE_MATH
...
#endif  // SAFEMATH_SAFE_MATH_CLANG_GCC_IMPL_H_
