...
DECLARE_DISPTAG(MsgQueueDispatcher, ZX_OBJ_TYPE_MSGQUEUE, "MSGQ")
DECLARE_DISPTAG(CalleesRefDispatcher, ZX_OBJ_TYPE_CALLEESREF, "CLRF")
DECLARE_DISPTAG(NewChannelDispatcher, ZX_OBJ_TYPE_NEWCHANNEL, "NCHN")
