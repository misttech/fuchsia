...
template affine::Ratio arm_generic_timer_compute_conversion_factors<true>(uint32_t cntfrq);
template affine::Ratio arm_generic_timer_compute_conversion_factors<false>(uint32_t cntfrq);
