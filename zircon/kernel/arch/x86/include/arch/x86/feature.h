...
#define X86_FEATURE_TOPOLOGY_SHIFT X86_CPUID_BIT(0xb, 0, 0)
#define X86_FEATURE_TOPOLOGY_SINGLE_PROCESSOR X86_CPUID_BIT(0xb, 0, 1)
#define X86_FEATURE_TOPOLOGY_LOGICAL_PROCESSOR X86_CPUID_BIT(0xb, 0, 8)
#define X86_FEATURE_TOPOLOGY_CORE X86_CPUID_BIT(0xb, 0, 9)
