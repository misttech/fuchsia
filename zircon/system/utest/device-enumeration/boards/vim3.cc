...
TEST_F(DeviceEnumerationTest, Vim3DeviceTreeTest) {
  static const char* kNodeMonikers[] = {
      ...
      "dev.sys.platform.usb-phy-ffe09000.usb-phy-ffe09000_group.aml_usb_phy",
      "dev.sys.platform.usb-phy-ffe09000.usb-phy-ffe09000_group.aml_usb_phy.dwc2",
      "dev.sys.platform.usb-ff400000.usb-ff400000_group.dwc2",
      "dev.sys.platform.usb-ff400000.usb-ff400000_group.dwc2.usb-peripheral.function-000.cdc-eth-function",
      "dev.sys.platform.usb-phy-ffe09000.usb-phy-ffe09000_group.aml_usb_phy.xhci",
      "dev.sys.platform.power-controller.power-controller_group.power-impl.power-core.power-0",
      "dev.sys.platform.power-controller.power-controller_group.power-impl.power-core.power-0.cpu-controller-0_group",
