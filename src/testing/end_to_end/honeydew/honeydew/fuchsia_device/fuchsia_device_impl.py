...
from honeydew.fuchsia_device.async_fuchsia_device_impl import (
    AsyncFuchsiaDeviceImpl,
)
...
class FuchsiaDeviceImpl(
    ...
    def __init__(
        ...
        *,
        ...
        self._inner = AsyncFuchsiaDeviceImpl(
            _outer=self,
    ...
    def as_async(self) -> "AsyncFuchsiaDeviceImpl":
        return self._inner
