...
class UserInputFCTests(unittest.TestCase):
    ...
    def test_create_mouse_device(self, register_mouse) -> None:  # type: ignore[no-untyped-def]
        ...
        self.assertIsNotNone(mouse_device._inner._mouse_proxy)
    ...
    def test_scroll(self, unused_register_mouse, simulate_mouse_event) -> None:  # type: ignore[no-untyped-def]
