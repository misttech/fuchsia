...
const _: () = {
    ["Size of mbstate_t"][::std::mem::size_of::<mbstate_t>() - 8usize];
    ["Alignment of mbstate_t"][::std::mem::align_of::<mbstate_t>() - 1usize];
    ["Offset of field: mbstate_t::__seq"][::std::mem::offset_of!(mbstate_t, __seq) - 0usize];
    ["Offset of field: mbstate_t::__reserved"]
        [::std::mem::offset_of!(mbstate_t, __reserved) - 4usize];
};
unsafe extern "C" {
...
unsafe extern "C" {
    #[doc = " Put an int32_t associated with the provided key.\n New values with the same key will overwrite existing values.\n\n \\param pBundle to operate on\n \\param key for the mapping in UTF-8\n \\param val value to put for the mapping\n\n Available since API level 202404."]
...
unsafe extern "C" {
    #[doc = " Put an int64_t associated with the provided key.\n New values with the same key will overwrite existing values.\n\n \\param pBundle to operate on\n \\param key for the mapping in UTF-8\n \\param val value to put for the mapping\n\n Available since API level 202404."]
...
unsafe extern "C" {
    #[doc = " Put a double associated with the provided key.\n New values with the same key will overwrite existing values.\n\n \\param pBundle to operate on\n \\param key for the mapping in UTF-8\n \\param val value to put for the mapping\n\n Available since API level 202404."]
...
unsafe extern "C" {
    #[doc = " Put a string associated with the provided key.\n New values with the same key will overwrite existing values.\n The value is copied.\n\n \\param pBundle to operate on\n \\param key for the mapping in UTF-8\n \\param vec vector to put for the mapping\n\n Available since API level 202404."]
...
unsafe extern "C" {
    #[doc = " Put a boolean vector associated with the provided key.\n New values with the same key will overwrite existing values.\n The values are copied.\n\n \\param pBundle to operate on\n \\param key for the mapping in UTF-8\n \\param vec vector to put for the mapping\n \\param num number of elements in the vector\n\n Available since API level 202404."]
...
unsafe extern "C" {
    #[doc = " Put an int32_t vector associated with the provided key.\n New values with the same key will overwrite existing values.\n The values are copied.\n\n \\param pBundle to operate on\n \\param key for the mapping in UTF-8\n \\param vec vector to put for the mapping\n \\param num number of elements in the vector\n\n Available since API level 202404."]
...
unsafe extern "C" {
    #[doc = " Put an int64_t vector associated with the provided key.\n New values with the same key will overwrite existing values.\n The values are copied.\n\n \\param pBundle to operate on\n \\param key for the mapping in UTF-8\n \\param vec vector to put for the mapping\n \\param num number of elements in the vector\n\n Available since API level 202404."]
...
unsafe extern "C" {
    #[doc = " Put a double vector associated with the provided key.\n New values with the same key will overwrite existing values.\n The values are copied.\n\n \\param pBundle to operate on\n \\param key for the mapping in UTF-8\n \\param vec vector to put for the mapping\n \\param num number of elements in the vector\n\n Available since API level 202404."]
...
unsafe extern "C" {
    #[doc = " Put a string vector associated with the provided key.\n New values with the same key will overwrite existing values.\n The values are copied.\n\n \\param pBundle to operate on\n \\param key for the mapping in UTF-8\n \\param vec vector to put for the mapping\n \\param num number of elements in the vector\n\n Available since API level 202404."]
...
unsafe extern "C" {
    #[doc = " Put an APersistableBundle associated with the provided key.\n New values with the same key will overwrite existing values.\n The value is deep-copied.\n\n \\param pBundle to operate on\n \\param key for the mapping in UTF-8\n \\param val value to put for the mapping\n\n Available since API level 202404."]
...
unsafe extern "C" {
    #[doc = " Get an int32_t associated with the provided key.\n\n Available since API level 202404.\n\n \\param pBundle to operate on\n \\param key for the mapping in UTF-8\n \\param val pointer to write the value to\n\n \\return true if a value exists for the provided key"]
...
unsafe extern "C" {
    #[doc = " Get an int64_t associated with the provided key.\n\n Available since API level 202404.\n\n \\param pBundle to operate on\n \\param key for the mapping in UTF-8\n \\param val pointer to write the value to\n\n \\return true if a value exists for the provided key"]
...
unsafe extern "C" {
    #[doc = " Get a double associated with the provided key.\n\n Available since API level 202404.\n\n \\param pBundle to operate on\n \\param key for the mapping in UTF-8\n \\param val pointer to write the value to\n\n \\return true if a value exists for the provided key"]
...
unsafe extern "C" {
    #[doc = " Get an int32_t vector associated with the provided key and place it in the\n provided pre-allocated buffer from the user.\n\n This function returns the size in bytes of stored vector.\n The supplied buffer will be filled in based on the smaller of the supplied\n bufferSizeBytes or the actual size of the stored data.\n If the buffer is null or if the supplied bufferSizeBytes is smaller than the\n actual stored data, then not all of the stored data will be returned.\n\n Users can call this function with null buffer and 0 bufferSizeBytes to get\n the required size of the buffer to use on a subsequent call.\n\n \\param pBundle to operate on\n \\param key for the mapping in UTF-8\n \\param buffer pointer to a pre-allocated buffer to write the values to\n \\param bufferSizeBytes size of the pre-allocated buffer\n\n \\return size of the stored vector in bytes. This is the required size of the\n pre-allocated user supplied buffer if all of the stored contents are desired.\n         APERSISTABLEBUNDLE_KEY_NOT_FOUND if the key was not found"]
...
unsafe extern "C" {
    #[doc = " Get an int64_t vector associated with the provided key and place it in the\n provided pre-allocated buffer from the user.\n\n This function returns the size in bytes of stored vector.\n The supplied buffer will be filled in based on the smaller of the supplied\n bufferSizeBytes or the actual size of the stored data.\n If the buffer is null or if the supplied bufferSizeBytes is smaller than the\n actual stored data, then not all of the stored data will be returned.\n\n Users can call this function with null buffer and 0 bufferSizeBytes to get\n the required size of the buffer to use on a subsequent call.\n\n \\param pBundle to operate on\n \\param key for the mapping in UTF-8\n \\param buffer pointer to a pre-allocated buffer to write the values to\n \\param bufferSizeBytes size of the pre-allocated buffer\n\n \\return size of the stored vector in bytes. This is the required size of the\n pre-allocated user supplied buffer if all of the stored contents are desired.\n         APERSISTABLEBUNDLE_KEY_NOT_FOUND if the key was not found"]
...
unsafe extern "C" {
    #[doc = " Get a double vector associated with the provided key and place it in the\n provided pre-allocated buffer from the user.\n\n This function returns the size in bytes of stored vector.\n The supplied buffer will be filled in based on the smaller of the supplied\n bufferSizeBytes or the actual size of the stored data.\n If the buffer is null or if the supplied bufferSizeBytes is smaller than the\n actual stored data, then not all of the stored data will be returned.\n\n Users can call this function with null buffer and 0 bufferSizeBytes to get\n the required size of the buffer to use on a subsequent call.\n\n \\param pBundle to operate on\n \\param key for the mapping in UTF-8\n \\param buffer pointer to a pre-allocated buffer to write the values to\n \\param bufferSizeBytes size of the pre-allocated buffer\n\n \\return size of the stored vector in bytes. This is the required size of the\n pre-allocated user supplied buffer if all of the stored contents are desired.\n         APERSISTABLEBUNDLE_KEY_NOT_FOUND if the key was not found"]
...
pub enum AServiceManager_AddServiceFlag {
    ...
    #[doc = " Allows services to dump sections according to priorities and format"]
...
#[repr(u32)]
#[non_exhaustive]
#[doc = " These are the different SELinux permissions that processes need to have for\n different operations with servicemanager."]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
pub enum AServiceManager_PermissionType {
    #[doc = " Permission for a process to \"find\" this service through ServiceManager\n APIs like AServiceManager_getService or AServiceManager_waitForService"]
    CHECK_ACCESS_PERMISSION_FIND = 0,
    #[doc = " Permission for a process to \"list\" services with\n libbinder's IServiceManager::listServices"]
    CHECK_ACCESS_PERMISSION_LIST = 1,
    #[doc = " Permission for a process to \"add\", or register, a service with\n servicemanager through AServiceManager_addService"]
...
pub const APERSISTABLEBUNDLE_KEY_NOT_FOUND: android_c_interface_consts__bindgen_ty_3 = -1;
pub const APERSISTABLEBUNDLE_ALLOCATOR_FAILED: android_c_interface_consts__bindgen_ty_3 = -2;
pub type android_c_interface_consts__bindgen_ty_3 = ::std::os::raw::c_int;
