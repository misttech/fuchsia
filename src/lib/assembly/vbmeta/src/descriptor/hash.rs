...
#[repr(C, packed)]
pub(crate) struct HashDescriptorHeader {
    pub(crate) tag: BigEndianU64,
    pub(crate) num_bytes_following: BigEndianU64,
    pub(crate) image_size: BigEndianU64,
    pub(crate) hash_alg: [u8; 32],
    pub(crate) image_name_size: BigEndianU32,
    pub(crate) salt_size: BigEndianU32,
    pub(crate) digest_size: BigEndianU32,
    pub(crate) flags: BigEndianU32,
    pub(crate) pad: [u8; 60],
}
...
impl HashDescriptorHeader {
    ...
    pub(crate) fn bytes_for_algorithm(algorithm: &str) -> [u8; 32] {
    ...
    pub(crate) fn calculate_num_bytes_following(
        image_name_size: u32,
        salt_size: u32,
        digest_size: u32,
    ) -> u64 {
...
mod tests {
    use super::*;
    use crate::descriptor::hash_builder::HashDescriptorBuilder;
    ...
    #[test]
    fn test_simple_hash_descriptor_from_builder() {
        let (inputs, outputs) = simple_test_setup();

        let h = HashDescriptorBuilder::default()
    ...
    /// usual kind, and requires the HashDescriptorBuilder to create.
    #[test]
