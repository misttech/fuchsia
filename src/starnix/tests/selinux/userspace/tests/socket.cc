...
INSTANTIATE_TEST_SUITE_P(
    ...
    ::testing::Values(
        ...
        NetlinkSocketTestCase{
            ...
            "test_u:test_r:netlink_socket_nlmsg_write_no_t:s0", fit::error(EACCES)},
        ...
        NetlinkSocketTestCase{NETLINK_AUDIT, AUDIT_LIST_RULES, NLM_F_REQUEST | NLM_F_DUMP,
                              "test_u:test_r:netlink_socket_nlmsg_readpriv_yes_t:s0", fit::ok()},
        NetlinkSocketTestCase{NETLINK_AUDIT, AUDIT_LIST_RULES, NLM_F_REQUEST | NLM_F_DUMP,
                              "test_u:test_r:netlink_socket_nlmsg_readpriv_no_t:s0",
                              fit::error(EACCES)},
        NetlinkSocketTestCase{NETLINK_AUDIT, AUDIT_USER, NLM_F_REQUEST,
                              "test_u:test_r:netlink_socket_nlmsg_relay_yes_t:s0", fit::ok()},
        NetlinkSocketTestCase{NETLINK_AUDIT, AUDIT_USER, NLM_F_REQUEST,
                              "test_u:test_r:netlink_socket_nlmsg_relay_no_t:s0",
                              fit::error(EACCES)},
        ...
        NetlinkSocketTestCase{NETLINK_AUDIT, AUDIT_TTY_SET, NLM_F_REQUEST,
                              "test_u:test_r:netlink_socket_nlmsg_tty_audit_yes_t:s0", fit::ok()},
        NetlinkSocketTestCase{NETLINK_AUDIT, AUDIT_TTY_SET, NLM_F_REQUEST,
                              "test_u:test_r:netlink_socket_nlmsg_tty_audit_no_t:s0",
                              fit::error(EACCES)},
        NetlinkSocketTestCase{NETLINK_AUDIT, AUDIT_SET, NLM_F_REQUEST,
                              "test_u:test_r:netlink_socket_nlmsg_write_yes_t:s0", fit::ok()},
        NetlinkSocketTestCase{NETLINK_AUDIT, AUDIT_SET, NLM_F_REQUEST,
                              "test_u:test_r:netlink_socket_nlmsg_write_no_t:s0",
                              fit::error(EACCES)},
