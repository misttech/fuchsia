...
struct OperationContext<'a> {
    ...
    connection_security_state: &'a security::BinderConnectionState,
    binder_proc: &'a BinderProcess,
    binder_thread: &'a BinderThread,
...
pub mod tests {
    ...
    use starnix_uapi::{
        ...
        BINDER_TYPE_WEAK_HANDLE, binder_buffer_object, binder_fd_array_object, binder_fd_object,
        binder_object_header, binder_transaction_data__bindgen_ty_1,
        binder_transaction_data__bindgen_ty_2, binder_transaction_data__bindgen_ty_2__bindgen_ty_1,
    };
    use static_assertions::const_assert;
    use std::sync::Weak;
    use zerocopy::{FromBytes, FromZeros, KnownLayout};
