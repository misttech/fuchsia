...
use crate::constants::*;
use crate::unix::nlas::Nla;
use crate::unix::{
    ShowFlags, StateFlags, UnixRequest, UnixResponse, UnixResponseBuffer, UnixResponseHeader,
};

static SOCKET_INFO: LazyLock<UnixRequest> = LazyLock::new(|| UnixRequest {
...
static LISTENING: LazyLock<UnixResponse> = LazyLock::new(|| UnixResponse {
...
static ESTABLISHED: LazyLock<UnixResponse> = LazyLock::new(|| UnixResponse {
    header: UnixResponseHeader {
        kind: SOCK_STREAM,
