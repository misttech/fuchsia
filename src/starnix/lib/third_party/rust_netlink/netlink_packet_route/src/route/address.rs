...
use crate::ip::{
    IPV4_ADDR_LEN, IPV6_ADDR_LEN, emit_ip_to_buffer, parse_ipv4_addr, parse_ipv6_addr,
};
use crate::route::MplsLabel;
...
impl RouteAddress {
    pub fn parse(address_family: AddressFamily, payload: &[u8]) -> Result<Self, DecodeError> {
