...
fn test_ip_netns_query_reply() {
    let raw = vec![0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x01, 0x00, 0x63, 0x00, 0x00, 0x00];

    let expected = NsidMessage {
        header: NsidHeader { family: AddressFamily::Unspec },
...
fn test_ip_netns_query() {
    let raw = vec![0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x03, 0x00, 0x06, 0x00, 0x00, 0x00];
...
fn test_ip_netns_query_target_ns_id() {
    let raw = vec![0x00, 0x00, 0x00, 0x00, 0x08, 0x00, 0x04, 0x00, 0x63, 0x00, 0x00, 0x00];
