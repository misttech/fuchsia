...
fn test_ipv4_tcp_sport_dport_realm() {
    ...
    let expected = RuleMessage {
        ...
        attributes: vec![
            ...
            RuleAttribute::DestinationPortRange(RulePortRange { start: 8080, end: 8080 }),
...
fn test_ipv4_udp_sport_range_dport_range_reals_src_dst() {
    ...
    let expected = RuleMessage {
        ...
        attributes: vec![
            ...
            RuleAttribute::SourcePortRange(RulePortRange { start: 80, end: 8080 }),
            RuleAttribute::DestinationPortRange(RulePortRange { start: 8080, end: 9090 }),
