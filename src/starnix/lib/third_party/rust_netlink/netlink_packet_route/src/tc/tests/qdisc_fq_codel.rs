    ...
    let expected = TcMessage {
        ...
        attributes: vec![
            ...
            TcAttribute::Stats2(vec![
                TcStats2::App(TcXstats::FqCodel(TcFqCodelXstats::Qdisc(TcFqCodelQdStats {
                    maxpacket: 368,
                    drop_overlimit: 0,
                    ecn_mark: 0,
                    new_flow_count: 36,
                ...
                TcStats2::Basic(TcStatsBasic { bytes: 14698466, packets: 92089 }),
            ...
            TcAttribute::Xstats(TcXstats::FqCodel(TcFqCodelXstats::Qdisc(TcFqCodelQdStats {
                maxpacket: 368,
                drop_overlimit: 0,
                ecn_mark: 0,
                new_flow_count: 36,
