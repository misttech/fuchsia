...
#[repr(C)]
#[derive(Debug, Default, Copy, Clone, IntoBytes, FromBytes, Immutable, KnownLayout)]
pub struct timespec {
    pub tv_sec: time_t,
...
#[repr(C)]
#[derive(
    Debug, Default, Copy, Clone, PartialEq, Eq, IntoBytes, FromBytes, Immutable, KnownLayout,
)]
pub struct in_addr {
