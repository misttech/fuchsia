...
#ifndef SRC_UI_SCENIC_LIB_SCHEDULING_PESSIMISTIC_DURATION_PREDICTOR_H_
#define SRC_UI_SCENIC_LIB_SCHEDULING_PESSIMISTIC_DURATION_PREDICTOR_H_
...
#endif  // SRC_UI_SCENIC_LIB_SCHEDULING_PESSIMISTIC_DURATION_PREDICTOR_H_
