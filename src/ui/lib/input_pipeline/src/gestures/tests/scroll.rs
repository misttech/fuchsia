...
mod test {
    ...
    async fn scroll() {
        ...
        let inputs = vec![
            ...
            touchpad_event(vec![finger1_pos2_um, finger2_pos2_um], SortedVecSet::new()),
        ];
    ...
    mod chain {
        ...
        async fn scroll_lift_1finger_then_move() {
            ...
            let inputs = vec![
                touchpad_event(vec![finger1_pos1_um, finger2_pos1_um], SortedVecSet::new()),
                touchpad_event(vec![finger1_pos2_um, finger2_pos2_um], SortedVecSet::new()),
                touchpad_event(vec![finger1_pos3_um], SortedVecSet::new()),
                touchpad_event(vec![finger1_pos4_um], SortedVecSet::new()),
            ];
            let got = utils::run_gesture_arena_test(inputs).await;
        ...
        async fn scroll_lift_1finger_then_one_finger_drag() {
            ...
            let inputs = vec![
                touchpad_event(vec![finger1_pos0_um, finger2_pos0_um], SortedVecSet::new()),
                touchpad_event(vec![finger1_pos1_um, finger2_pos1_um], SortedVecSet::new()),
