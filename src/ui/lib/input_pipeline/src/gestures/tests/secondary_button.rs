...
mod tests {
    ...
    mod click {
        ...
        async fn secondary_click_keep_contact() {
            ...
            let inputs = vec![
                touchpad_event(vec![finger1_pos0_um], SortedVecSet::new()),
                touchpad_event(vec![finger1_pos1_um, finger2_pos1_um], SortedVecSet::new()),
                touchpad_event(vec![finger1_pos2_um, finger2_pos2_um], SortedVecSet::from(vec![1])),
                touchpad_event(vec![finger1_pos3_um, finger2_pos3_um], SortedVecSet::new()),
                // ensure no unexpected tap event.
                touchpad_event(vec![finger1_pos4_um, finger2_pos4_um], SortedVecSet::new()),
                touchpad_event(vec![], SortedVecSet::new()),
            ];
            ...
            assert_matches!(got[2].as_slice(), [
              ...
              assert_eq!(pressed_button_a, &SortedVecSet::from(vec![2]));
              assert_eq!(affected_button_a, &SortedVecSet::from(vec![2]));
            ...
            assert_matches!(got[3].as_slice(), [
              ...
              assert_eq!(pressed_button_a, &SortedVecSet::new());
              assert_eq!(affected_button_a, &SortedVecSet::from(vec![2]));
              assert_eq!(location_a, &utils::NO_MOVEMENT_LOCATION);
            });
        ...
        async fn secondary_click_lift_one_then_other() {
            ...
            let inputs = vec![
                ...
                touchpad_event(vec![finger1_pos3_um, finger2_pos3_um], SortedVecSet::new()),
                // ensure no unexpected tap event.
                touchpad_event(vec![finger1_pos4_um], SortedVecSet::new()),
                touchpad_event(vec![], SortedVecSet::new()),
            ];
        ...
        async fn secondary_click_lift_one_while_button_down() {
            ...
            let inputs = vec![
                ...
                touchpad_event(vec![finger1_pos1_um, finger2_pos1_um], SortedVecSet::new()),
                touchpad_event(vec![finger1_pos2_um, finger2_pos2_um], SortedVecSet::from(vec![1])),
                touchpad_event(vec![finger1_pos3_um], SortedVecSet::from(vec![1])),
                touchpad_event(vec![finger1_pos4_um], SortedVecSet::new()),
            ];
    ...
    mod click_chain {
        ...
        async fn secondary_click_then_one_finger_button_down() {
            ...
            let inputs = vec![
                ...
                touchpad_event(vec![finger1_pos3_um, finger2_pos3_um], SortedVecSet::new()),
                touchpad_event(vec![finger1_pos4_um], SortedVecSet::new()),
                touchpad_event(vec![finger1_pos5_um], SortedVecSet::from(vec![1])),
            ];
        ...
        async fn secondary_click_then_secondary_button_down() {
            ...
            let inputs = vec![
                ...
                touchpad_event(vec![finger1_pos3_um, finger2_pos3_um], SortedVecSet::new()),
                touchpad_event(vec![finger1_pos4_um, finger2_pos4_um], SortedVecSet::new()),
                touchpad_event(vec![finger1_pos5_um, finger2_pos5_um], SortedVecSet::from(vec![1])),
            ];
        ...
        async fn secondary_click_then_motion() {
            ...
            let inputs = vec![
                ...
                touchpad_event(vec![finger1_pos3_um, finger2_pos3_um], SortedVecSet::new()),
                touchpad_event(vec![finger1_pos4_um], SortedVecSet::new()),
                touchpad_event(vec![finger1_pos5_um], SortedVecSet::new()),
            ];
            ...
            assert_matches!(got[5].as_slice(), [
              ...
              assert_eq!(pressed_button_a, &SortedVecSet::new());
              assert_eq!(affected_button_a, &SortedVecSet::new());
        ...
        async fn secondary_click_then_scroll() {
            ...
            let inputs = vec![
                ...
                touchpad_event(vec![finger1_pos4_um, finger2_pos4_um], SortedVecSet::new()),
                touchpad_event(vec![finger1_pos5_um, finger2_pos5_um], SortedVecSet::new()),
            ];
    ...
    mod drag {
        ...
        async fn secondary_drag_keep_contact() {
            ...
            let inputs = vec![
                ...
                touchpad_event(vec![finger1_pos1_um, finger2_pos1_um], SortedVecSet::new()),
                touchpad_event(vec![finger1_pos2_um, finger2_pos2_um], SortedVecSet::from(vec![1])),
                touchpad_event(vec![finger1_pos3_um, finger2_pos3_um], SortedVecSet::from(vec![1])),
                touchpad_event(vec![finger1_pos4_um, finger2_pos4_um], SortedVecSet::new()),
                // ensure no unexpected tap event.
                touchpad_event(vec![finger1_pos5_um, finger2_pos5_um], SortedVecSet::new()),
                touchpad_event(vec![], SortedVecSet::new()),
        ...
        async fn secondary_drag_use_1_finger() {
            ...
            let inputs = vec![
                ...
                touchpad_event(vec![finger1_pos2_um, finger2_pos2_um], SortedVecSet::from(vec![1])),
                touchpad_event(vec![finger1_pos3_um], SortedVecSet::from(vec![1])),
                touchpad_event(vec![finger1_pos4_um], SortedVecSet::from(vec![1])),
                touchpad_event(vec![finger1_pos5_um], SortedVecSet::new()),
                touchpad_event(vec![], SortedVecSet::new()),
            ];
    ...
    mod drag_chain {
        ...
        async fn secondary_drag_then_one_finger_button_down() {
            ...
            let inputs = vec![
                ...
                touchpad_event(vec![finger1_pos4_um, finger2_pos4_um], SortedVecSet::new()),
                touchpad_event(vec![finger1_pos5_um], SortedVecSet::new()),
                touchpad_event(vec![finger1_pos6_um], SortedVecSet::from(vec![1])),
            ];
        ...
        async fn secondary_drag_then_motion() {
            ...
            let inputs = vec![
                ...
                touchpad_event(vec![finger1_pos4_um, finger2_pos4_um], SortedVecSet::new()),
                touchpad_event(vec![finger1_pos5_um], SortedVecSet::new()),
                touchpad_event(vec![finger1_pos6_um], SortedVecSet::new()),
            ];
        ...
        async fn secondary_drag_then_scroll() {
            ...
            let inputs = vec![
                ...
                touchpad_event(vec![finger1_pos4_um, finger2_pos4_um], SortedVecSet::new()),
                touchpad_event(vec![finger1_pos5_um, finger2_pos5_um], SortedVecSet::new()),
                touchpad_event(vec![finger1_pos6_um, finger2_pos6_um], SortedVecSet::new()),
            ];
