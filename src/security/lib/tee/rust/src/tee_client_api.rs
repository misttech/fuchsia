...
pub const ZX_MIN_PAGE_SIZE: u32 = 4096;
pub const ZX_MAX_PAGE_SIZE: u32 = 2097152;
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct zx_pager_vmo_stats {
    pub modified: u32,
}
pub type zx_pager_vmo_stats_t = zx_pager_vmo_stats;
