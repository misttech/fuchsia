...
TEST_F(EdidTest, GetManufacturerIdAndName) {
  ...
  static constexpr std::span<const uint8_t> kHpZr30wEdid(kHpZr30wEdidArray);
...
TEST_F(EdidTest, GetDisplayProductNameWithoutNameDescriptor) {
  ...
  static constexpr std::span<const uint8_t> kHpZr30wWithoutNameDescriptorEdid(
...
TEST_F(EdidTest, GetDisplayProductSerialWithoutSerialDescriptor) {
  ...
  static constexpr std::span<const uint8_t> kHpZr30wWithoutSerialDescriptorEdid(
