...
use crate::model::testing::echo_service::{ECHO_CAPABILITY, EchoProtocol};
...
pub struct RoutingTestBuilder {
    ...
    injected_capabilities: Vec<cm_config::InjectedCapabilities>,
...
impl RoutingTestBuilder {
    ...
    #[cfg(feature = "src_model_tests")]
    pub fn add_injected_capabilities(
        mut self,
        injected_capabilities: InjectedCapabilities,
    ) -> Self {
        self.injected_capabilities.push(injected_capabilities);
        self
    }
...
impl RoutingTest {
    ...
    async fn from_builder(mut builder: RoutingTestBuilder) -> Self {
        ...
        let config = RuntimeConfig {
            ...
            inject_capabilities: builder.injected_capabilities,
            ..Default::default()
        };
...
impl RoutingTestModel for RoutingTest {
    ...
    async fn check_test_dir_tree_contains(&self, expected: String) {
        assert!(
            list_directory_recursive(&self.test_dir_proxy)
                .await
                .iter()
