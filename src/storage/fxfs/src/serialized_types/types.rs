...
pub const LATEST_VERSION: Version = Version { major: 49, minor: 0 };
...
mod tests {
    ...
    use crate::object_store::transaction::{
        MutationV40, MutationV41, MutationV43, MutationV46, MutationV47, MutationV49,
    };
