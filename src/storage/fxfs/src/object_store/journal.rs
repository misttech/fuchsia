...
use crate::object_store::transaction::{
    ...
    MutationV47, MutationV49, ObjectStoreMutation, Options, TRANSACTION_MAX_JOURNAL_USAGE,
    Transaction, TxnMutation, lock_keys,
};
...
pub type JournalRecord = JournalRecordV49;
