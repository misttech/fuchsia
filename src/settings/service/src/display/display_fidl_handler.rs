...
pub(crate) type SubscriberObject = (UsageResponsePublisher<DisplayInfo>, DisplayWatchResponder);
...
impl DisplayFidlHandler {
    ...
    fn hanging_get(info: &DisplayInfo, (usage_responder, responder): SubscriberObject) -> bool {
