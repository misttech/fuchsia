...
class FcTransportStatus(Exception):
  FC_OK: int
...
def channel_create(context: InternalHandle) -> tuple[InternalHandle, InternalHandle]: ...
...
def socket_create(context: InternalHandle, options: int) -> tuple[InternalHandle, InternalHandle]: ...
...
def event_create(context: InternalHandle) -> InternalHandle: ...
def event_create_pair(context: InternalHandle) -> tuple[InternalHandle, InternalHandle]: ...
