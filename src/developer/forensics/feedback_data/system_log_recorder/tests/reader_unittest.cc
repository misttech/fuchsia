...
TEST(ReaderTest, SortsMessages) {
  ...
  EXPECT_TRUE(store.Add(BuildLogMessage(FUCHSIA_LOG_INFO, "line 1.1", zx::msec(1))));
  EXPECT_TRUE(store.Add(BuildLogMessage(FUCHSIA_LOG_INFO, "duplicated line", zx::msec(5))));
