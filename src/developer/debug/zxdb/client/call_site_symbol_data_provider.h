...
class CallSiteSymbolDataProvider : public ProcessSymbolDataProvider {
 public:
  ...
  std::optional<std::span<const uint8_t>> GetRegister(debug::RegisterID id) override;
 ...
 private:
  ...
  // the frame_provider_.
  //
  // TODO(https://fxbug.dev/42153991) remove this when the unwinder only reports registers it knows about.
