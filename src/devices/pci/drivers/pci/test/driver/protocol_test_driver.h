...
#ifndef SRC_DEVICES_PCI_DRIVERS_PCI_TEST_DRIVER_PROTOCOL_TEST_DRIVER_H_
#define SRC_DEVICES_PCI_DRIVERS_PCI_TEST_DRIVER_PROTOCOL_TEST_DRIVER_H_
...
#endif  // SRC_DEVICES_PCI_DRIVERS_PCI_TEST_DRIVER_PROTOCOL_TEST_DRIVER_H_
