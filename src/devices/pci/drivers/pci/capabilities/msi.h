...
#ifndef SRC_DEVICES_PCI_DRIVERS_PCI_CAPABILITIES_MSI_H_
#define SRC_DEVICES_PCI_DRIVERS_PCI_CAPABILITIES_MSI_H_
...
#endif  // SRC_DEVICES_PCI_DRIVERS_PCI_CAPABILITIES_MSI_H_
