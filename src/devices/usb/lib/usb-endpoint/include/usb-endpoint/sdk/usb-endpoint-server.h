...
#ifndef SRC_DEVICES_USB_LIB_USB_ENDPOINT_INCLUDE_USB_ENDPOINT_SDK_USB_ENDPOINT_SERVER_H_
#define SRC_DEVICES_USB_LIB_USB_ENDPOINT_INCLUDE_USB_ENDPOINT_SDK_USB_ENDPOINT_SERVER_H_
...
using RequestVariant = std::variant<usb::FidlRequest>;
...
#endif  // SRC_DEVICES_USB_LIB_USB_ENDPOINT_INCLUDE_USB_ENDPOINT_SDK_USB_ENDPOINT_SERVER_H_
