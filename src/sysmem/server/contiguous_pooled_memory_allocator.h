...
#ifndef SRC_SYSMEM_SERVER_CONTIGUOUS_POOLED_MEMORY_ALLOCATOR_H_
#define SRC_SYSMEM_SERVER_CONTIGUOUS_POOLED_MEMORY_ALLOCATOR_H_
...
#endif  // SRC_SYSMEM_SERVER_CONTIGUOUS_POOLED_MEMORY_ALLOCATOR_H_
