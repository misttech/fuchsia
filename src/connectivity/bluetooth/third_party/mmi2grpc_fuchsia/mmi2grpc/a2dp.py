...
class A2DPProxy(ProfileProxy):
    ...
    @assert_description
    def TSC_AVDTPEX_mmi_iut_initiate_l2cap_basic_signaling_channel(
        self, **kwargs
    ):
        """
        Take action to initiate an AVDTP signaling channel.

        Note: The IUT must
        require Basic L2cap configuration for this test case.
        """

        return "OK"

    @assert_description
    def TSC_AVDTPEX_mmi_iut_initiate_l2cap_ert_signaling_channel(
        self, **kwargs
    ):
        """
        Take action to initiate an AVDTP signaling channel.
        ...
        Note: The IUT must
        require Enhanced Retransmission Mode during the l2cap connection for
        this test case.
        """
    ...
    @assert_description
    def TSC_AVDTPEX_mmi_iut_accept_l2cap_ert_signaling_channel(self, **kwargs):
        """
        Take action to accept the signaling channel from the tester.

        Note: The
        IUT must accept the Enhanced Retransmission Mode L2cap configuration for
        this test case.
        """
    ...
    def TSC_AVDTP_mmi_iut_initiate_reconfigure(self, **kwargs):
        ...
        # TODO(https://fxbug.dev/396500079): Implement.
    ...
    @assert_description
    def TSC_AVDTP_mmi_iut_initiate_get_configuration(self, **kwargs):
        """
        Take action to initiate an AVDTP Get Configuration command.
        """
    ...
    def TSC_AVDTP_mmi_iut_accept_reconnect(self, pts_addr: bytes, **kwargs):
        ...
        """
        time.sleep(3)
        self.host.Connect(address=pts_addr).connection
