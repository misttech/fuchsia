...
class AVRCPProxy(ProfileProxy):
    ...
    @assert_description
    def TSC_AVRCP_mmi_iut_accept_get_folder_items_media_player_list(
        self, **kwargs
    ):
        """
    ...
    @assert_description
    def TSC_AVDTP_mmi_iut_initiate_connect(
        self, test: str, pts_addr: bytes, **kwargs
    ):
        """
    ...
    @assert_description
    def TSC_AVRCP_mmi_iut_reject_invalid_command_control_channel(
        self, **kwargs
    ):
        """
    ...
    @assert_description
    def TSC_AVRCP_mmi_iut_reject_invalid_command_browsing_channel(
        self, **kwargs
    ):
        """
    ...
    @assert_description
    def TSC_AVRCP_mmi_iut_accept_get_folder_items_virtual_file_system(
        self, **kwargs
    ):
        """
        Take action to send a valid response to the [Get Folder Items] with the
    ...
    @assert_description
    def TSC_AVRCP_mmi_iut_reject_set_player_application_setting_value_invalid_pair(
        self, **kwargs
    ):
        """
    ...
    @assert_description
    def TSC_AVRCP_mmi_iut_accept_get_current_player_application_setting_value(
        self, **kwargs
    ):
        """
    ...
    @assert_description
    def TSC_AVRCP_mmi_iut_accept_list_player_application_setting_attributes(
        self, **kwargs
    ):
        """
    ...
    @assert_description
    def TSC_AVRCP_mmi_iut_accept_list_player_application_setting_values(
        self, **kwargs
    ):
        """
        Take action to send a valid response to the [List Player Application
    ...
    @assert_description
    def TSC_AVRCP_mmi_iut_reject_set_addressed_player_invalid_player_id(
        self, **kwargs
    ):
        """
    ...
    @assert_description
    def TSC_AVRCP_mmi_iut_reject_get_item_attributes_invalid_uid_counter(
        self, **kwargs
    ):
        """
    ...
    @assert_description
    def TSC_AVRCP_mmi_iut_initiate_register_notification_changed_track_changed(
        self, **kwargs
    ):
        """
        Take action to trigger a [Register Notification, Changed] response for
    ...
    @assert_description
    def TSC_AVRCP_mmi_iut_reject_set_browsed_player_invalid_player_id(
        self, **kwargs
    ):
        """
    ...
    @assert_description
    def TSC_AVRCP_mmi_iut_reject_register_notification_notify_invalid_event_id(
        self, **kwargs
    ):
        """
    ...
    @assert_description
    def TSC_AVRCP_mmi_user_confirm_now_playing_list_updated_with_local(
        self, **kwargs
    ):
        """
    ...
    def TSC_AVCTP_mmi_send_AVCT_ConnectReq(self, pts_addr: bytes, **kwargs):
        ...
        * PID = PIDTest_System
        ...
        # TODO(https://fxbug.dev/396500079): Implement this?
        ...
        # sleep(3)
        # self.l2cap.Connect(connection=self.connection, basic=ConnectionOrientedChannelRequest(psm=25, mtu=4096))
    ...
    @assert_description
    def TSC_AVCTP_mmi_register_DisconnectCfm_CB(
    ...
    def TSC_AVCTP_mmi_send_AVCT_Disconnect_Req(
        self, test: str, pts_addr: bytes, **kwargs
    ):
        """
    ...
    @assert_description
    def TSC_AVCTP_mmi_send_AVCT_SendMessage_CT(self, **kwargs):
        """
        ...
        the following parameter values:
            ...
            *
        Transaction = TRANSTest_System
            * Type = CRTest_System = 0 (Command
        Message)
            * PID = PIDTest_System
            * Data = ADDRESSdata_buffer
        (Buffer holding DATA[]Upper_Tester)
            * Length =
        LengthOf(DATA[]Upper_Tester) <= MTU – 3bytes
        """
