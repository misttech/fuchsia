...
class MacAddrDeviceInterface {
 public:
  ...
  // guaranteed to be) called recursively from the Create call. Because of this it's a good idea to
  // avoid acquiring locks in the on_created callback when an error is reported.
