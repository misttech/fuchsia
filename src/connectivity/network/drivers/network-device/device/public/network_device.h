 ...
 public:
  ...
  class Sys {
   public:
    ...
    // Notifies system of thread creation. Default implementation does nothing.
    //
    // Used to install profiles for created threads.
  ...
  //
  // |sys| is an optional unowned pointer to an object providing system capabilities.
