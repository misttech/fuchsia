...
//
// Usage of this type assumes that the parent device speaks Banjo while the
// underlying netdevice speaks FIDL. Consequently, this type translates calls
// from netdevice into the parent from FIDL to Banjo and calls from the parent
// into netdevice from Banjo to FIDL.
class NetworkDeviceShim : public fdf::WireServer<netdriver::NetworkDeviceImpl>,
 ...
 public:
  ...
  // NetworkDeviceImplFactory implementation
