...
class DeviceInterface : public fidl::WireServer<netdev::Device>,
 ...
 private:
  ...
  friend testing::FakeFidlNetworkDeviceImpl;
  ...
  zx_status_t Init(std::unique_ptr<NetworkDeviceImplBinder>&& factory);
  ...
  std::unique_ptr<NetworkDeviceImplBinder> factory_;
