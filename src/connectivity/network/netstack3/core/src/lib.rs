...
pub mod filter {
    ...
    pub use netstack3_filter::{
        ...
        FilterIpExt, FilterIpPacket, Hook, IpPacket, IpRoutines, MarkAction, NatRoutines,
        PacketMatcher, ProofOfEgressCheck, Routine, Routines, Rule, SocketEgressFilterResult,
...
pub mod ip {
    ...
    // Re-exported types.
    pub use netstack3_base::{
        AddressMatcher, AddressMatcherEither, AddressMatcherType, Mark, MarkDomain,
        MarkInDomainMatcher, MarkMatcher, MarkMatchers, Marks, PortMatcher, SubnetMatcher,
        WrapBroadcastMarker,
    };
