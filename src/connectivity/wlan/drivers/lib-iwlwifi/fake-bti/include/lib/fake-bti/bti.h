...
// ZX_MAX_PAGE_SIZE is chosen so that so superficial validity checks like "is the address
// correctly aligned" and "is the address non-zero" in the code under test will pass.
