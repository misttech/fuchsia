			      ...
			      struct iwl_tof_responder_config_cmd_v9 *cmd)
{
	...
	u32 r2i_max_sts =
		IWL_MVM_FTM_R2I_MAX_STS < 2 ? IWL_MVM_FTM_R2I_MAX_STS : 1;
...
static int iwl_mvm_ftm_responder_cmd(struct iwl_mvm *mvm,
...
static int
iwl_mvm_ftm_responder_dyn_cfg_v2(struct iwl_mvm *mvm, struct ieee80211_vif *vif,
...
static int
iwl_mvm_ftm_responder_dyn_cfg_v3(struct iwl_mvm *mvm, struct ieee80211_vif *vif,
				 struct ieee80211_ftm_responder_params *params,
				  ...
				  struct ieee80211_ftm_responder_params *params)
{
	...
	u8 cmd_ver = iwl_fw_lookup_cmd_ver(
		mvm->fw, WIDE_ID(LOCATION_GROUP, TOF_RESPONDER_DYN_CONFIG_CMD),
		2);

	switch (cmd_ver) {
	case 2:
		ret = iwl_mvm_ftm_responder_dyn_cfg_v2(mvm, vif, params);
		break;
	case 3:
		ret = iwl_mvm_ftm_responder_dyn_cfg_v3(mvm, vif, params, NULL);
		break;
	default:
...
int iwl_mvm_ftm_respoder_add_pasn_sta(struct iwl_mvm *mvm,
				      ...
				      u32 cipher, u8 *tk, u32 tk_len, u8 *hltk,
				      u32 hltk_len)
{
	int ret;
...
void iwl_mvm_ftm_responder_clear(struct iwl_mvm *mvm, struct ieee80211_vif *vif)
{
	struct iwl_mvm_pasn_sta *sta, *prev;
