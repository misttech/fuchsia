...
pub const AKM_OWE: Akm = Akm::new_dot11(OWE);
...
impl Akm {
    ...
    pub fn is_reserved(&self) -> bool {
        // IEEE 802.11-2016, 9.4.2.25.4, Table 9-133
        // The AKM is reserved if it has an IEEE 802.11 OUI and the suite is **not** defined above.
        !((EAP..=FT_EAP_SHA384).contains(&self.suite_type)
            || self.suite_type == OWE
