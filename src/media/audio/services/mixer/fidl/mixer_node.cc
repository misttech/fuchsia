...
zx::duration MixerNode::PresentationDelayForSourceEdge(const Node* source) const {
  ...
  // TODO(https://fxbug.dev/42065670): Handle the case where the sampler type is explicitly chosen
  // in the FIDL API - this may require to access the actual sampler being used for this source.
