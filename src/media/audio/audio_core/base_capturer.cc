...
//
// TODO(https://fxbug.dev/42172801): increase this, to account for worst-case cross-clock rate
// mismatches and mixes that may take longer than 1.5 msec.
...
// TODO(https://fxbug.dev/42172801): pad this further if needed, based on worst-case capture mix
// measurements. Or reconsider continuously recalculating this delay.
...
void BaseCapturer::UpdateFormat(Format format) {
  ...
  //
  // TODO(https://fxbug.dev/42115795): Limit this to something smaller than one second of frames.
