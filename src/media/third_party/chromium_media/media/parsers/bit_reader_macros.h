...
#ifndef SRC_MEDIA_THIRD_PARTY_CHROMIUM_MEDIA_MEDIA_PARSERS_BIT_READER_MACROS_H_
#define SRC_MEDIA_THIRD_PARTY_CHROMIUM_MEDIA_MEDIA_PARSERS_BIT_READER_MACROS_H_
...
#define READ_BITS_OR_RETURN(num_bits, out)                                 \
  do {                                                                     \
    ...
    *out = static_cast<std::remove_reference_t<decltype(*out)>>(_out);     \
  } while (0)
...
#endif  // SRC_MEDIA_THIRD_PARTY_CHROMIUM_MEDIA_MEDIA_PARSERS_BIT_READER_MACROS_H_
