...
#ifndef SRC_MEDIA_THIRD_PARTY_CHROMIUM_MEDIA_MEDIA_PARSERS_H264_PARSER_H_
#define SRC_MEDIA_THIRD_PARTY_CHROMIUM_MEDIA_MEDIA_PARSERS_H264_PARSER_H_
...
struct MEDIA_EXPORT H264NALU {
  ...
  //
  // This will remain empty if using QueuePreparsedNalu().
...
struct MEDIA_EXPORT H264SliceHeader {
  ...
  const uint8_t* nalu_data = nullptr;  // from NAL header
...
#endif  // SRC_MEDIA_THIRD_PARTY_CHROMIUM_MEDIA_MEDIA_PARSERS_H264_PARSER_H_
