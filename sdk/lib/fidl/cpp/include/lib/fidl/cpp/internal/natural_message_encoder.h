...
#ifndef LIB_FIDL_CPP_INTERNAL_NATURAL_MESSAGE_ENCODER_H_
#define LIB_FIDL_CPP_INTERNAL_NATURAL_MESSAGE_ENCODER_H_
...
#endif  // LIB_FIDL_CPP_INTERNAL_NATURAL_MESSAGE_ENCODER_H_
