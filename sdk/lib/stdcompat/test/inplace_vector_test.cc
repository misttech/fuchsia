...
TEST(InplaceVectorTest, SafetyViolationDeathTests) {
  EXPECT_DEATH((stdcompat::cpp26::inplace_vector<int, 2>{1, 2, 3}), "");
  EXPECT_DEATH((stdcompat::cpp26::inplace_vector<int, 3>{1, 2, 3, 4, 5}), "");

  stdcompat::cpp26::inplace_vector<int, 1> v;
  v.push_back(1);
  EXPECT_DEATH(v.push_back(2), "");

  stdcompat::cpp26::inplace_vector<int, 1> v2;
  v2.emplace_back(1);
  EXPECT_DEATH(v2.emplace_back(2), "");

  EXPECT_DEATH((stdcompat::cpp26::inplace_vector<int, 2>(5)), "");
  EXPECT_DEATH((stdcompat::cpp26::inplace_vector<int, 2>(3, 42)), "");

  std::vector<int> source{1, 2, 3, 4, 5};
  EXPECT_DEATH((stdcompat::cpp26::inplace_vector<int, 3>(source.begin(), source.end())), "");
  EXPECT_DEATH((stdcompat::cpp26::inplace_vector<int, 3>(stdcompat::cpp23::from_range, source)),
               "");

  stdcompat::cpp26::inplace_vector<int, 2> v3;
  ...
  stdcompat::cpp26::inplace_vector<int, 3> v4{1, 2};
  EXPECT_DEATH(v4.resize(5), "");
  EXPECT_DEATH(v4.resize(5, 42), "");

  stdcompat::cpp26::inplace_vector<int, 3> v5{1, 2, 3};
  ...
  stdcompat::cpp26::inplace_vector<int, 3> v6{1, 2};
  std::vector<int> source4{3, 4, 5};
  EXPECT_DEATH(v6.append_range(source4), "");

  auto test_assignment_overflow = []() {
    stdcompat::cpp26::inplace_vector<int, 3> v_small;
    stdcompat::cpp26::inplace_vector<int, 3> v_large{1, 2, 3, 4, 5};
  };
  EXPECT_DEATH(test_assignment_overflow(), "");

  stdcompat::cpp26::inplace_vector<int, 2> v7{1};
...
TEST(InplaceVectorTest, ObjectLifecycleManagement) {
  ...
  {
    stdcompat::cpp26::inplace_vector<Counter, 3> v1;
    v1.emplace_back();
    v1.emplace_back();
    v1.emplace_back();

    stdcompat::cpp26::inplace_vector<Counter, 3> v2;
    v2.emplace_back();
    v2.emplace_back();
    v2.emplace_back();
  ...
  stdcompat::cpp26::inplace_vector<Tracker, 3> v3;
  v3.emplace_back();
  v3.emplace_back();
  ...
  {
    stdcompat::cpp26::inplace_vector<Tracker, 3> v4;
    v4.emplace_back();
    v4.emplace_back();
    v4.emplace_back();
...
TEST(InplaceVectorTest, BasicOperationsAndConstruction) {
  stdcompat::cpp26::inplace_vector<int, 4> v;
  EXPECT_TRUE(v.empty());
  EXPECT_EQ(v.size(), 0u);
  ...
  stdcompat::cpp26::inplace_vector<int, 4> v_init{4, 5, 6};
  EXPECT_EQ(v_init.size(), 3u);
  EXPECT_EQ(v_init[0], 4);
  EXPECT_EQ(v_init[1], 5);
  EXPECT_EQ(v_init[2], 6);

  stdcompat::cpp26::inplace_vector<int, 4> v_copy(v_init);
  ...
  stdcompat::cpp26::inplace_vector<int, 5> v1(3);
  EXPECT_EQ(v1.size(), 3u);
  EXPECT_EQ(v1[0], 0);
  EXPECT_EQ(v1[1], 0);
  EXPECT_EQ(v1[2], 0);

  stdcompat::cpp26::inplace_vector<int, 5> v2(3, 42);
  EXPECT_EQ(v2.size(), 3u);
  EXPECT_EQ(v2[0], 42);
  EXPECT_EQ(v2[1], 42);
  EXPECT_EQ(v2[2], 42);
  ...
  stdcompat::cpp26::inplace_vector<int, 4> v3(source.begin(), source.end());
  ...
  stdcompat::cpp26::inplace_vector<int, 4> v4(stdcompat::cpp23::from_range, source2);
  EXPECT_EQ(v4.size(), 3u);
  EXPECT_EQ(v4[0], 7);
  EXPECT_EQ(v4[1], 8);
  EXPECT_EQ(v4[2], 9);

  stdcompat::cpp26::inplace_vector<S, 2> v5;
  v5.emplace_back(42);
  EXPECT_EQ(v5[0].x, 42);

  stdcompat::cpp26::inplace_vector<int, 3> v6{1, 2, 3};
  int sum = 0;
...
TEST(InplaceVectorTest, IteratorFunctionality) {
  stdcompat::cpp26::inplace_vector<int, 3> v{7, 8, 9};
  EXPECT_EQ(v.front(), 7);
  EXPECT_EQ(v.back(), 9);
  ...
  stdcompat::cpp26::inplace_vector<int, 2> v2;
  v2.push_back(42);
  ...
  stdcompat::cpp26::inplace_vector<int, 5> v3{1, 2, 3};
  auto rit = v3.rbegin();
  EXPECT_EQ(*rit, 3);
  ++rit;
  EXPECT_EQ(*rit, 2);
  ...
  stdcompat::cpp26::inplace_vector<int, 5> v4{1, 2, 3};
  auto it = v4.begin() + 1;
  EXPECT_EQ(*it, 2);
...
TEST(InplaceVectorTest, MoveOnlyTypeAndMoveSemantics) {
  stdcompat::cpp26::inplace_vector<std::unique_ptr<int>, 2> v;
  v.push_back(std::make_unique<int>(42));
  v.emplace_back(new int(99));
  EXPECT_EQ(*v[0], 42);
  EXPECT_EQ(*v[1], 99);

  stdcompat::cpp26::inplace_vector<std::unique_ptr<int>, 3> v1;
  v1.emplace_back(std::make_unique<int>(42));
  v1.emplace_back(std::make_unique<int>(99));

  auto original_size = v1.size();
  stdcompat::cpp26::inplace_vector<std::unique_ptr<int>, 3> v2(std::move(v1));
  EXPECT_EQ(v2.size(), original_size);
  EXPECT_EQ(*v2[0], 42);
  EXPECT_EQ(*v2[1], 99);
  EXPECT_TRUE(v1.empty());

  stdcompat::cpp26::inplace_vector<std::unique_ptr<int>, 3> v3;
  v3.emplace_back(std::make_unique<int>(1));
  v3.emplace_back(std::make_unique<int>(2));

  stdcompat::cpp26::inplace_vector<std::unique_ptr<int>, 3> v4;
  ...
  stdcompat::cpp26::inplace_vector<std::unique_ptr<int>, 2> v5(std::move(v));
  EXPECT_EQ(*v5[0], 42);
  EXPECT_EQ(*v5[1], 99);

  stdcompat::cpp26::inplace_vector<std::unique_ptr<int>, 2> v6;
  v6 = std::move(v5);
  EXPECT_EQ(*v6[0], 42);
  EXPECT_EQ(*v6[1], 99);
}
...
TEST(InplaceVectorTest, SafeAndUnsafeInsertionOperations) {
  stdcompat::cpp26::inplace_vector<int, 3> v1;
  ...
  stdcompat::cpp26::inplace_vector<S, 2> v6;
  auto& ref3 = v6.unchecked_emplace_back(77);
  EXPECT_EQ(ref3.x, 77);
  EXPECT_EQ(v6.size(), 1u);

  stdcompat::cpp26::inplace_vector<int, 2> v7;
  ...
  stdcompat::cpp26::inplace_vector<S, 2> v8;
...
TEST(InplaceVectorTest, RangeOperations) {
  stdcompat::cpp26::inplace_vector<int, 5> v{1, 2};
  ...
  stdcompat::cpp26::inplace_vector<int, 5> v1{1, 2};
  ...
  stdcompat::cpp26::inplace_vector<int, 5> v2;
  ...
  stdcompat::cpp26::inplace_vector<int, 6> v5{1, 4};
...
TEST(InplaceVectorTest, ResizeOperations) {
  ...
  stdcompat::cpp26::inplace_vector<int, 5> v1{1, 2, 3};
  v1.resize(3);
  EXPECT_EQ(v1.size(), 3u);
  EXPECT_EQ(v1[0], 1);
  EXPECT_EQ(v1[1], 2);
...
TEST(InplaceVectorTest, AssignOperations) {
  ...
  stdcompat::cpp26::inplace_vector<int, 5> v2{1, 2, 3};
  v2.assign(2, 99);
  ...
  stdcompat::cpp26::inplace_vector<int, 5> v5{1, 2, 3};
  v5.assign({});
  EXPECT_EQ(v5.size(), 0u);
  EXPECT_TRUE(v5.empty());

  std::vector<int> empty_source;
  stdcompat::cpp26::inplace_vector<int, 5> v6{1, 2, 3};
...
TEST(InplaceVectorTest, InsertOperations) {
  stdcompat::cpp26::inplace_vector<int, 6> v1{1, 4};
  ...
  stdcompat::cpp26::inplace_vector<std::unique_ptr<int>, 3> v2;
  ...
  stdcompat::cpp26::inplace_vector<int, 6> v3{1, 4};
  ...
  stdcompat::cpp26::inplace_vector<int, 6> v4{1, 4};
  ...
  stdcompat::cpp26::inplace_vector<S, 3> v6;
  v6.emplace_back(1);
  v6.emplace_back(3);
...
TEST(InplaceVectorTest, EraseOperations) {
  stdcompat::cpp26::inplace_vector<int, 5> v1{1, 2, 3, 4};
  ...
  stdcompat::cpp26::inplace_vector<int, 5> v2{1, 2, 3, 4, 5};
  ...
  stdcompat::cpp26::inplace_vector<int, 5> v5{1, 2, 3, 4, 5};
...
TEST(InplaceVectorTest, SwapOperations) {
  stdcompat::cpp26::inplace_vector<int, 3> v1{1, 2};
  stdcompat::cpp26::inplace_vector<int, 3> v2{3, 4, 5};
  ...
  stdcompat::cpp26::inplace_vector<int, 3> v3{1, 2};
  stdcompat::cpp26::inplace_vector<int, 3> v4{3, 4, 5};
  ...
  stdcompat::cpp26::inplace_vector<int, 5> v5{1, 2, 3, 4};
  stdcompat::cpp26::inplace_vector<int, 5> v6{5};
  ...
  stdcompat::cpp26::inplace_vector<int, 0> v7;
  stdcompat::cpp26::inplace_vector<int, 0> v8;
...
TEST(InplaceVectorTest, ComparisonOperators) {
  stdcompat::cpp26::inplace_vector<int, 3> v1{1, 2, 3};
  stdcompat::cpp26::inplace_vector<int, 3> v2{1, 2, 3};
  stdcompat::cpp26::inplace_vector<int, 3> v3{1, 2, 4};
  stdcompat::cpp26::inplace_vector<int, 3> v4{1, 2};
  ...
  stdcompat::cpp26::inplace_vector<int, 5> v5{1, 2};
  stdcompat::cpp26::inplace_vector<int, 5> v6{1, 2, 3};
...
TEST(InplaceVectorTest, GlobalEraseOperations) {
  stdcompat::cpp26::inplace_vector<int, 5> v1{1, 2, 2, 3, 2};
  ...
  stdcompat::cpp26::inplace_vector<int, 5> v3{1, 3, 5};
...
TEST(InplaceVectorTest, ContainerManagement) {
  stdcompat::cpp26::inplace_vector<int, 5> v{1, 2, 3};
...
TEST(InplaceVectorTest, TypeAliasesAndRuntimeBehavior) {
  constexpr auto capacity_5 = stdcompat::cpp26::inplace_vector<int, 5>::capacity();
  EXPECT_EQ(capacity_5, 5u);
  constexpr auto max_size_10 = stdcompat::cpp26::inplace_vector<int, 10>::max_size();
  EXPECT_EQ(max_size_10, 10u);

  stdcompat::cpp26::inplace_vector<int, 3> v;
  EXPECT_TRUE(v.empty());
  EXPECT_EQ(v.size(), 0u);
  ...
  using Vec = stdcompat::cpp26::inplace_vector<int, 5>;
  Vec v3{1, 2, 3};
  ...
  *ptr = 200;
  ...
  constexpr auto capacity_7 = stdcompat::cpp26::inplace_vector<int, 7>::capacity();
  EXPECT_EQ(capacity_7, 7u);
  constexpr auto max_size_7 = stdcompat::cpp26::inplace_vector<int, 7>::max_size();
  ...
  *it = 300;
  ...
  stdcompat::cpp26::inplace_vector<int, 2> safe_test;
  ...
  stdcompat::cpp26::inplace_vector<int, 3> move_test1{1, 2, 3};
  stdcompat::cpp26::inplace_vector<int, 3> move_test2{std::move(move_test1)};
  ...
  stdcompat::cpp26::inplace_vector<int, 3> move_test3;
...
TEST(InplaceVectorTest, ConstructorSFINAE) {
  stdcompat::cpp26::inplace_vector<int, 5> v1(3, 42);
  EXPECT_EQ(v1.size(), 3u);
  EXPECT_EQ(v1[0], 42);
  EXPECT_EQ(v1[1], 42);
  EXPECT_EQ(v1[2], 42);
  ...
  std::vector<int> source{1, 2, 3};
  stdcompat::cpp26::inplace_vector<int, 5> v2(source.begin(), source.end());
  EXPECT_EQ(v2.size(), 3u);
  EXPECT_EQ(v2[0], 1);
  EXPECT_EQ(v2[1], 2);
  EXPECT_EQ(v2[2], 3);
  ...
  stdcompat::cpp26::inplace_vector<int, 5> v3(stdcompat::cpp23::from_range, source1);
  EXPECT_EQ(v3.size(), 3u);
  EXPECT_EQ(v3[0], 1);
  EXPECT_EQ(v3[1], 2);
  EXPECT_EQ(v3[2], 3);
  ...
  int source2[] = {4, 5, 6, 7};
  stdcompat::cpp26::inplace_vector<int, 6> v4(stdcompat::cpp23::from_range, source2);
  EXPECT_EQ(v4.size(), 4u);
  EXPECT_EQ(v4[0], 4);
  EXPECT_EQ(v4[1], 5);
  EXPECT_EQ(v4[2], 6);
  ...
  stdcompat::cpp26::inplace_vector<int, 4> v5(stdcompat::cpp23::from_range, source3);
  EXPECT_EQ(v5.size(), 2u);
  EXPECT_EQ(v5[0], 8);
  EXPECT_EQ(v5[1], 9);

  std::vector<int> empty_source;
  stdcompat::cpp26::inplace_vector<int, 3> v6(stdcompat::cpp23::from_range, empty_source);
  EXPECT_EQ(v6.size(), 0u);
  EXPECT_TRUE(v6.empty());
}
...
TEST(InplaceVectorTest, BatchInsertEdgeCases) {
  stdcompat::cpp26::inplace_vector<int, 5> v1{1, 3};
  std::vector<int> empty_range;
  ...
  stdcompat::cpp26::inplace_vector<int, 5> v2{3, 4};
  ...
  std::vector<int> source{1, 2, 3};
  stdcompat::cpp26::inplace_vector<int, 6> v3{0, 4};
  ...
  stdcompat::cpp26::inplace_vector<int, 6> v4{0, 8};
...
TEST(InplaceVectorTest, ZeroCapacityEdgeCases) {
  stdcompat::cpp26::inplace_vector<int, 0> v;
  ...
  stdcompat::cpp26::inplace_vector<int, 0> v2(v);
  EXPECT_EQ(v2.size(), 0u);

  stdcompat::cpp26::inplace_vector<int, 0> v3;
  v3 = v;
  EXPECT_EQ(v3.size(), 0u);

  stdcompat::cpp26::inplace_vector<int, 0> v4(std::move(v));
  EXPECT_EQ(v4.size(), 0u);
  EXPECT_EQ(v.size(), 0u);

  stdcompat::cpp26::inplace_vector<int, 0> v5;
  v5 = std::move(v4);
  EXPECT_EQ(v5.size(), 0u);
