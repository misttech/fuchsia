...
#ifndef LIB_FDF_CHANNEL_READ_H_
#define LIB_FDF_CHANNEL_READ_H_
...
struct fdf_channel_read {
  ...
  // TODO(https://fxbug.dev/42167288): Decide if we want a sticky option akin to
  // ZX_WAIT_ASYNC_REPEATING (and maybe default to it when the dispatcher is unsynchronized?).
  uint32_t options;
};

__END_CDECLS

#endif  // LIB_FDF_CHANNEL_READ_H_
