...
[products](/docs/development/build/software_assembly/build_configuration.md#products) to
create a collection of build targets. The
[bringup product](/docs/development/build/software_assembly/build_configuration.md#bringup-product)
