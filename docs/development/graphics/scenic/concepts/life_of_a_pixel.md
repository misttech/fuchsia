...
![Visual representation of classes and calls for a client Present request to become a pixel on screen.](/docs/development/graphics/scenic/meta/life_of_pixel.svg)
