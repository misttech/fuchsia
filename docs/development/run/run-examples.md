...
[Introduction to GN](/docs/development/build/gn_concepts/intro.md).
...
[fetched and launched on demand](/docs/development/build/software_assembly/build_configuration.md#universe).
