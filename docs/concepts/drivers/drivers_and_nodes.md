...
![Node topology diagram showing a hierarchy from a root node to specific SPI device nodes, with drivers bound to nodes.](images/diagram_node_topology_01.svg "Basic node topology"){: width="550"}
...
![Node topology diagram showing a USB bus node with child devices, highlighting a USB keyboard driver bound to a device node.](images/diagram_node_topology_02.svg "USB bug node topology"){: width="550"}
...
![Component topology diagram showing drivers and driver hosts organized into collections under driver_manager.cm.](images/diagram_driver_component_topology_01.svg "Component topology example"){: width="600"}
...
![Diagram showing a composite node ('camera') with two parent nodes ('gpio-enable' and 'pci-device') bound to a driver.](images/diagram_composite_node_01.svg "Composite node example"){: width="375"}
...
![Diagram showing a complex binding topology for a camera controller driver with multiple parent nodes.](images/diagram_composite_drivers_01.svg "Composite drivers example"){: width="550"}
