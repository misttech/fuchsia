...
[fuchsia-build]: /docs/development/build/overview.md
...
[gn-best-rebase-path]: /docs/development/build/gn_concepts/templates.md#prefer-relative-paths-from-rebase-path
