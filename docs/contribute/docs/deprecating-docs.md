...
1. In the [`/docs/_common/_deprecated-docs.yaml`][deprecated-docs] file, create
   a redirect for the deprecated pages to the
   [deprecation notice][deprecation-notice] page. Also include a comment listing
   the deprecate feature with a deprecation date. For example:
...
[deprecated-docs]: /docs/_common/_deprecated-docs.yaml
