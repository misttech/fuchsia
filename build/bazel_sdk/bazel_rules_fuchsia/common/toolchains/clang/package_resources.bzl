...
# applied, then the value passed to fuchsia_cpu_select() to remove entries
# that are not related to a supported CPU architecture.
...
def get_clang_package_resources(clang_repo_prefix, lib_clang_internal_dir, supported_cpus):
    ...
    to call fuchsia_package_esource_group() or a similar in-tree custom rule to
    ...
    Args:
       ...
       lib_clang_internal_dir: The Clang internal directly, relative
    ...
    Returns:
       ...
       to call the fuchsia_package_resource() rule, or an equivalent in-tree
       ...
       A typical use case would look like this:
           ...
           ```
           load("@rules_fuchsia//fuchsia:defs.bzl", "fuchsia_package_resource")
           load("@rules_fuchsia//common:toolchains/clang/package_resources.bzl", "get_clang_package_resources")
