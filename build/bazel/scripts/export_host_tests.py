...
bazel_host_tests/build/bazel/host_tests/
    cc_tests/
        dynamic_test
        dynamic_test.repo_mapping
        dynamic_test.runfiles/
            ....
        dynamic_test.runfiles_manifest

        ...
```

Where `.../cc_tests/dynamic_test` is the test entry point that is listed in the
corresponding entry generated by the `list` command.

NOTE: In many cases, the test executable (e.g. `dynamic_test` here) *MUST* be invoked
      from the Ninja build directory to work correctly.
"""
