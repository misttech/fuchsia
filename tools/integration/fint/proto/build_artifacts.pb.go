...
type BuildArtifacts struct {
	...
	NinjatraceJsonFiles []string `protobuf:"bytes,3,rep,name=ninjatrace_json_files,json=ninjatraceJsonFiles,proto3" json:"ninjatrace_json_files,omitempty"`
	// Collection of buildstats files to upload.
	BuildstatsJsonFiles []string `protobuf:"bytes,4,rep,name=buildstats_json_files,json=buildstatsJsonFiles,proto3" json:"buildstats_json_files,omitempty"`
	// The duration taken by the ninja build step.
	NinjaDurationSeconds int32 `protobuf:"varint,5,opt,name=ninja_duration_seconds,json=ninjaDurationSeconds,proto3" json:"ninja_duration_seconds,omitempty"`
	// Various ninja build data
	NinjaActionMetrics *NinjaActionMetrics `protobuf:"bytes,6,opt,name=ninja_action_metrics,json=ninjaActionMetrics,proto3" json:"ninja_action_metrics,omitempty"`
	...
	LogFiles map[string]string `protobuf:"bytes,7,rep,name=log_files,json=logFiles,proto3" json:"log_files,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	...
	// artifactory instead.
	DebugFiles []*DebugFile `protobuf:"bytes,8,rep,name=debug_files,json=debugFiles,proto3" json:"debug_files,omitempty"`
	// Whether an analysis of the build graph determined that the changed files do
	// not affect the build.
	BuildNotAffected bool `protobuf:"varint,9,opt,name=build_not_affected,json=buildNotAffected,proto3" json:"build_not_affected,omitempty"`
	...
	AffectedTests []string `protobuf:"bytes,10,rep,name=affected_tests,json=affectedTests,proto3" json:"affected_tests,omitempty"`
	// Human-readable names of fint operations that failed, e.g.
	// "debug_symbol_export", mapped to short error messages (unenforced but
	// suggested limit of 100 chars). These are purely used for reporting purposes
	// for bulk detection of failures.
	NonFatalFailures map[string]string `protobuf:"bytes,11,rep,name=non_fatal_failures,json=nonFatalFailures,proto3" json:"non_fatal_failures,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *BuildArtifacts) GetNonFatalFailures() map[string]string {
	if x != nil {
		return x.NonFatalFailures
	}
	return nil
}
...
var file_build_artifacts_proto_rawDesc = []byte{
	...
	0x70, 0x6c, 0x6f, 0x61, 0x64, 0x44, 0x65, 0x73, 0x74, 0x22, 0x83, 0x06, 0x0a, 0x0e, 0x42, 0x75,
	...
	0x6a, 0x73, 0x6f, 0x6e, 0x5f, 0x66, 0x69, 0x6c, 0x65, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x09,
	...
	0x61, 0x74, 0x73, 0x5f, 0x6a, 0x73, 0x6f, 0x6e, 0x5f, 0x66, 0x69, 0x6c, 0x65, 0x73, 0x18, 0x04,
	...
	0x6e, 0x64, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x05, 0x52, 0x14, 0x6e, 0x69, 0x6e, 0x6a, 0x61,
	...
	0x6d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e,
	...
	0x6f, 0x67, 0x5f, 0x66, 0x69, 0x6c, 0x65, 0x73, 0x18, 0x07, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x22,
	...
	0x64, 0x65, 0x62, 0x75, 0x67, 0x5f, 0x66, 0x69, 0x6c, 0x65, 0x73, 0x18, 0x08, 0x20, 0x03, 0x28,
	...
	,
...
var file_build_artifacts_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_build_artifacts_proto_goTypes = []interface{}{
	...
	nil,                        // 5: fint.BuildArtifacts.NonFatalFailuresEntry
...
var file_build_artifacts_proto_depIdxs = []int32{
	...
	6, // 1: fint.BuildArtifacts.built_images:type_name -> google.protobuf.Struct
	0, // 2: fint.BuildArtifacts.ninja_action_metrics:type_name -> fint.NinjaActionMetrics
	4, // 3: fint.BuildArtifacts.log_files:type_name -> fint.BuildArtifacts.LogFilesEntry
	1, // 4: fint.BuildArtifacts.debug_files:type_name -> fint.DebugFile
	5, // 5: fint.BuildArtifacts.non_fatal_failures:type_name -> fint.BuildArtifacts.NonFatalFailuresEntry
