...
type BuildArtifacts struct {
	...
	NonFatalFailures map[string]string `protobuf:"bytes,12,rep,name=non_fatal_failures,json=nonFatalFailures,proto3" json:"non_fatal_failures,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
var file_build_artifacts_proto_rawDesc = []byte{
	...
	0x70, 0x6c, 0x6f, 0x61, 0x64, 0x44, 0x65, 0x73, 0x74, 0x22, 0xc3, 0x06, 0x0a, 0x0e, 0x42, 0x75,
...
var file_build_artifacts_proto_depIdxs = []int32{
	...
	6, // 2: fint.BuildArtifacts.built_archives:type_name -> google.protobuf.Struct
	...
	5, // 6: fint.BuildArtifacts.non_fatal_failures:type_name -> fint.BuildArtifacts.NonFatalFailuresEntry
