...
type Static struct {
	...
	IncludeImages bool `protobuf:"varint,11,opt,name=include_images,json=includeImages,proto3" json:"include_images,omitempty"`
	// Whether to build manifests of prebuilt binaries.
	IncludePrebuiltBinaryManifests bool `protobuf:"varint,12,opt,name=include_prebuilt_binary_manifests,json=includePrebuiltBinaryManifests,proto3" json:"include_prebuilt_binary_manifests,omitempty"`
	// Whether to build generated source files specified in the generated sources manifest.
	IncludeGeneratedSources bool `protobuf:"varint,13,opt,name=include_generated_sources,json=includeGeneratedSources,proto3" json:"include_generated_sources,omitempty"`
	...
	SkipIfUnaffected bool `protobuf:"varint,17,opt,name=skip_if_unaffected,json=skipIfUnaffected,proto3" json:"skip_if_unaffected,omitempty"`
	// The path within the checkout of a file containing historical test duration
	// data specific to the current build config.
	TestDurationsFile string `protobuf:"bytes,18,opt,name=test_durations_file,json=testDurationsFile,proto3" json:"test_durations_file,omitempty"`
	...
	DefaultTestDurationsFile string `protobuf:"bytes,19,opt,name=default_test_durations_file,json=defaultTestDurationsFile,proto3" json:"default_test_durations_file,omitempty"`
	// Which IDE files to generate.
	IdeFiles []string `protobuf:"bytes,20,rep,name=ide_files,json=ideFiles,proto3" json:"ide_files,omitempty"`
	// Passed to --json-ide-script GN flag; GN will execute each of these scripts
	// after regenerating the project.json IDE file.
	JsonIdeScripts []string `protobuf:"bytes,21,rep,name=json_ide_scripts,json=jsonIdeScripts,proto3" json:"json_ide_scripts,omitempty"`
	// Whether to set --export-rust-project GN flag.
	ExportRustProject bool `protobuf:"varint,22,opt,name=export_rust_project,json=exportRustProject,proto3" json:"export_rust_project,omitempty"`
	// If true, build Rust targets with RBE/reclient.
	RustRbeEnable bool `protobuf:"varint,23,opt,name=rust_rbe_enable,json=rustRbeEnable,proto3" json:"rust_rbe_enable,omitempty"`
	// If true, build C++ targets with RBE/reclient.
	CxxRbeEnable bool `protobuf:"varint,24,opt,name=cxx_rbe_enable,json=cxxRbeEnable,proto3" json:"cxx_rbe_enable,omitempty"`
	// Whether we're performing an incremental build.
	Incremental bool `protobuf:"varint,25,opt,name=incremental,proto3" json:"incremental,omitempty"`
	// Whether to include the the default ninja target.
	IncludeDefaultNinjaTarget bool `protobuf:"varint,26,opt,name=include_default_ninja_target,json=includeDefaultNinjaTarget,proto3" json:"include_default_ninja_target,omitempty"`
	...
	UseTemporaryGoCache bool `protobuf:"varint,27,opt,name=use_temporary_go_cache,json=useTemporaryGoCache,proto3" json:"use_temporary_go_cache,omitempty"`
	// Which language-specific lint targets to include.
	IncludeLintTargets Static_LintTargets `protobuf:"varint,28,opt,name=include_lint_targets,json=includeLintTargets,proto3,enum=fint.Static_LintTargets" json:"include_lint_targets,omitempty"`
	// Extra args to pass to ninja.
	NinjaArgs []string `protobuf:"bytes,29,rep,name=ninja_args,json=ninjaArgs,proto3" json:"ninja_args,omitempty"`
	...
	HermeticTestPackages []string `protobuf:"bytes,30,rep,name=hermetic_test_packages,json=hermeticTestPackages,proto3" json:"hermetic_test_packages,omitempty"`
	...
	TestPackages []string `protobuf:"bytes,31,rep,name=test_packages,json=testPackages,proto3" json:"test_packages,omitempty"`
	...
	E2ETestLabels []string `protobuf:"bytes,32,rep,name=e2e_test_labels,json=e2eTestLabels,proto3" json:"e2e_test_labels,omitempty"`
	...
	HostTestLabels []string `protobuf:"bytes,33,rep,name=host_test_labels,json=hostTestLabels,proto3" json:"host_test_labels,omitempty"`
	...
	// empty list.
	DeveloperTestLabels []string `protobuf:"bytes,34,rep,name=developer_test_labels,json=developerTestLabels,proto3" json:"developer_test_labels,omitempty"`
	...
	// package sets.
	BuildOnlyLabels []string `protobuf:"bytes,35,rep,name=build_only_labels,json=buildOnlyLabels,proto3" json:"build_only_labels,omitempty"`
	// If true, link C/C++ targets remotely with RBE/reclient.
	LinkRbeEnable bool `protobuf:"varint,36,opt,name=link_rbe_enable,json=linkRbeEnable,proto3" json:"link_rbe_enable,omitempty"`
	// If true, enable remote builds for bazel on RBE.
	BazelRbeEnable bool `protobuf:"varint,37,opt,name=bazel_rbe_enable,json=bazelRbeEnable,proto3" json:"bazel_rbe_enable,omitempty"`
	...
	BuildEventService string `protobuf:"bytes,38,opt,name=build_event_service,json=buildEventService,proto3" json:"build_event_service,omitempty"`
	// If set, points to the label to use as the main product bundle in a
	// multi-product build.
	MainPbLabel string `protobuf:"bytes,39,opt,name=main_pb_label,json=mainPbLabel,proto3" json:"main_pb_label,omitempty"`
	...
	BuildEventServiceNinja string `protobuf:"bytes,40,opt,name=build_event_service_ninja,json=buildEventServiceNinja,proto3" json:"build_event_service_ninja,omitempty"`
}
...
var file_static_proto_rawDesc = []byte{
	...
	0x66, 0x69, 0x6e, 0x74, 0x22, 0x84, 0x10, 0x0a, 0x06, 0x53, 0x74, 0x61, 0x74, 0x69, 0x63, 0x12,
	...
	0x61, 0x6e, 0x74, 0x73, 0x12, 0x12, 0x0a, 0x04, 0x70, 0x61, 0x76, 0x65, 0x18, 0x0a, 0x20, 0x01,
	0x28, 0x08, 0x52, 0x04, 0x70, 0x61, 0x76, 0x65, 0x12, 0x25, 0x0a, 0x0e, 0x69, 0x6e, 0x63, 0x6c,
	0x75, 0x64, 0x65, 0x5f, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x73, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x08,
	...
	0x65, 0x73, 0x74, 0x73, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x08, 0x52, 0x1e, 0x69, 0x6e, 0x63, 0x6c,
	...
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x73, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x08, 0x52, 0x17, 0x69,
	...
	0x65, 0x5f, 0x68, 0x6f, 0x73, 0x74, 0x5f, 0x74, 0x65, 0x73, 0x74, 0x73, 0x18, 0x0e, 0x20, 0x01,
	...
	0x61, 0x72, 0x63, 0x68, 0x69, 0x76, 0x65, 0x73, 0x18, 0x0f, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0f,
	0x69, 0x6e, 0x63, 0x6c, 0x75, 0x64, 0x65, 0x41, 0x72, 0x63, 0x68, 0x69, 0x76, 0x65, 0x73, 0x12,
	0x14, 0x0a, 0x05, 0x74, 0x6f, 0x6f, 0x6c, 0x73, 0x18, 0x10, 0x20, 0x03, 0x28, 0x09, 0x52, 0x05,
	0x74, 0x6f, 0x6f, 0x6c, 0x73, 0x12, 0x2c, 0x0a, 0x12, 0x73, 0x6b, 0x69, 0x70, 0x5f, 0x69, 0x66,
	0x5f, 0x75, 0x6e, 0x61, 0x66, 0x66, 0x65, 0x63, 0x74, 0x65, 0x64, 0x18, 0x11, 0x20, 0x01, 0x28,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x73, 0x5f, 0x66, 0x69, 0x6c, 0x65, 0x18, 0x12, 0x20, 0x01, 0x28, 0x09,
	...
	,
	...
	0x62, 0x6c, 0x65, 0x18, 0x18, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0c, 0x63, 0x78, 0x78, 0x52, 0x62,
	0x65, 0x45, 0x6e, 0x61, 0x62, 0x6c, 0x65, 0x12, 0x20, 0x0a, 0x0b, 0x69, 0x6e, 0x63, 0x72, 0x65,
	0x6d, 0x65, 0x6e, 0x74, 0x61, 0x6c, 0x18, 0x19, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0b, 0x69, 0x6e,
	...
	0x6a, 0x61, 0x5f, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x18, 0x1a, 0x20, 0x01, 0x28, 0x08, 0x52,
	...
	0x61, 0x63, 0x68, 0x65, 0x18, 0x1b, 0x20, 0x01, 0x28, 0x08, 0x52, 0x13, 0x75, 0x73, 0x65, 0x54,
	...
	0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x73, 0x18, 0x1c, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x18, 0x2e,
	...
	,
	...
	0x12, 0x07, 0x0a, 0x03, 0x58, 0x36, 0x34, 0x10, 0x02, 0x12, 0x0b, 0x0a, 0x07, 0x52, 0x49, 0x53,
	0x43, 0x56, 0x36, 0x34, 0x10, 0x03, 0x22, 0x53, 0x0a, 0x0b, 0x4c, 0x69, 0x6e, 0x74, 0x54, 0x61,
	0x72, 0x67, 0x65, 0x74, 0x73, 0x12, 0x13, 0x0a, 0x0f, 0x4e, 0x4f, 0x5f, 0x4c, 0x49, 0x4e, 0x54,
	0x5f, 0x54, 0x41, 0x52, 0x47, 0x45, 0x54, 0x53, 0x10, 0x00, 0x12, 0x14, 0x0a, 0x10, 0x41, 0x4c,
	0x4c, 0x5f, 0x4c, 0x49, 0x4e, 0x54, 0x5f, 0x54, 0x41, 0x52, 0x47, 0x45, 0x54, 0x53, 0x10, 0x01,
	0x12, 0x19, 0x0a, 0x15, 0x41, 0x46, 0x46, 0x45, 0x43, 0x54, 0x45, 0x44, 0x5f, 0x4c, 0x49, 0x4e,
	0x54, 0x5f, 0x54, 0x41, 0x52, 0x47, 0x45, 0x54, 0x53, 0x10, 0x02, 0x42, 0x35, 0x5a, 0x33, 0x67,
