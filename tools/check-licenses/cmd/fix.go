...
func (r *FixerRenderer) applyFix(e v2pipeline.ComplianceError) {
	...
	case "AllProjectsMustHaveALicense":
		if err := AddPolicyException(r.FuchsiaDir, e.CheckName, e.Project, "TODO: Auto-generated by fx check-licenses fix", "Auto-generated exception via fix"); err == nil {
	...
	case "AllLicenseTextsMustBeRecognized":
		...
		if err := AddPolicyException(r.FuchsiaDir, e.CheckName, e.FilePath, "TODO: Auto-generated by fx check-licenses fix", "Auto-generated exception via fix"); err == nil {
	...
	case "AllLicensePatternUsagesMustBeApproved":
		if err := AddAllowlistEntry(r.FuchsiaDir, e.LicenseID, e.Project, "TODO: Auto-generated by fx check-licenses fix", "Auto-generated allowlist entry via fix"); err == nil {
