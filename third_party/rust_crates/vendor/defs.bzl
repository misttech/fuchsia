...
_NORMAL_DEPENDENCIES = {
    "third_party/rust_crates": {
        _COMMON_CONDITION: {
            ...
            "which": Label("//third_party/rust_crates/vendor/which-8.0.3:which"),
...
_CONDITIONS = {
    ...
    "cfg(not(target_os = \"redox\"))": ["@rules_rust//rust/platform:aarch64-unknown-fuchsia", "@rules_rust//rust/platform:aarch64-unknown-linux-gnu", "@rules_rust//rust/platform:x86_64-unknown-fuchsia", "@rules_rust//rust/platform:x86_64-unknown-linux-gnu"],
