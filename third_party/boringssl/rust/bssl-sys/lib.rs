...
// --- Copied from third_party/boringssl/src/rust/bssl-sys/src/lib.rs ---
...
// Re-expose the retired ERR_GET_REASON_RUST helper for backward compatibility
// with older Rust clients (like Android KeyMint) in the Fuchsia tree.
//
// In the new BoringSSL, ERR_GET_REASON is a native C function, so we can
// just call it directly.
#[inline]
pub unsafe fn ERR_GET_REASON_RUST(code: u32) -> core::ffi::c_int {
    ERR_GET_REASON(code)
}
