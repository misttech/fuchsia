...
fips_fragments = [
    ...
    "src/crypto/fipsmodule/rand/android_entropy_client.cc.inc",
...
crypto_headers = [
    ...
    "src/include/openssl/configuration.h",
...
rust_bssl_crypto = [
    ...
    "src/rust/bssl-crypto/src/pkcs8.rs",
