...
pki_test_data = [
    ...
    "src/pki/testdata/path_builder_unittest/mtc/leaf.pem",
    "src/pki/testdata/path_builder_unittest/mtc/mtc-ica.pem",
    "src/pki/testdata/path_builder_unittest/mtc/mtc-leaf.pem",
