...
test_support_sources = [
    ...
    "src/crypto/test/der_trailing_data.h",
...
crypto_test_sources = [
    ...
    "src/crypto/curve25519/curve25519_test.cc",
    ...
    "src/crypto/x509/x509_extension_test.cc",
...
pki_test_sources = [
    ...
    "src/pki/merkle_tree_unittest.cc",
...
crypto_test_data = [
    ...
    "src/crypto/evp/test/mldsa_tests.txt",
    "src/crypto/evp/test/mlkem_tests.txt",
    "src/crypto/evp/test/rsa_tests.txt",
    "src/crypto/evp/test/scrypt_tests.txt",
    "src/crypto/evp/test/x25519_tests.txt",
    "src/crypto/evp/test/xwing_tests.txt",
    ...
    "src/crypto/hpke/hpke_test_vectors_pq.txt",
    ...
    "src/crypto/pkcs7/test/sign_cert2.pem",
    ...
    "src/crypto/pkcs7/test/sign_sha256_cert2.p7s",
    ...
    "src/crypto/rsa/test/rsa16384.pem",
    "src/crypto/rsa/test/rsa16384pub.pem",
    "src/crypto/rsa/test/rsa16385.pem",
    "src/crypto/rsa/test/rsa16385pub.pem",
    ...
    "src/crypto/slhdsa/slhdsa_sha2_128s_keygen.txt",
    "src/crypto/slhdsa/slhdsa_sha2_128s_prehash.txt",
    "src/crypto/slhdsa/slhdsa_sha2_128s_siggen.txt",
    "src/crypto/slhdsa/slhdsa_sha2_128s_sigver.txt",
    "src/crypto/slhdsa/slhdsa_shake_256f_keygen.txt",
    "src/crypto/slhdsa/slhdsa_shake_256f_siggen.txt",
    "src/crypto/slhdsa/slhdsa_shake_256f_sigver.txt",
    ...
    "src/crypto/x509/test/mtc/ca_cert.pem",
    "src/crypto/x509/test/mtc/cert_10_0.pem",
    "src/crypto/x509/test/mtc/cert_10_1.pem",
    "src/crypto/x509/test/mtc/cert_2034_0.pem",
    "src/crypto/x509/test/mtc/cert_2035_0.pem",
    "src/crypto/x509/test/mtc/cert_2_0.pem",
    "src/crypto/x509/test/mtc/cert_32_0.pem",
    "src/crypto/x509/test/mtc/cert_33_0.pem",
    "src/crypto/x509/test/mtc/cert_33_1.pem",
    "src/crypto/x509/test/mtc/cert_33_2.pem",
    "src/crypto/x509/test/mtc/cert_33_3.pem",
    "src/crypto/x509/test/mtc/cert_33_4.pem",
    "src/crypto/x509/test/mtc/cert_33_5.pem",
    "src/crypto/x509/test/mtc/cert_33_6.pem",
    "src/crypto/x509/test/mtc/cert_33_7.pem",
    "src/crypto/x509/test/mtc/cert_33_8.pem",
    "src/crypto/x509/test/mtc/cert_33_9.pem",
    "src/crypto/x509/test/mtc/cert_5036_0.pem",
    "src/crypto/x509/test/mtc/large_merkle_tree_consistency_proof_tests.txt",
    "src/crypto/x509/test/mtc/large_merkle_tree_inclusion_proof_tests.txt",
    ...
    "src/crypto/x509/test/rsa_pss_sha256_key.pk8",
    ...
    "src/crypto/x509/test/unusual_tbs_critical_ber.pem",
    "src/crypto/x509/test/unusual_tbs_critical_false_not_omitted.pem",
    "src/crypto/x509/test/unusual_tbs_empty_extension_not_omitted.pem",
    "src/crypto/x509/test/unusual_tbs_key.pem",
    "src/crypto/x509/test/unusual_tbs_null_sigalg_param.pem",
    "src/crypto/x509/test/unusual_tbs_uid_both.pem",
    "src/crypto/x509/test/unusual_tbs_uid_issuer.pem",
    "src/crypto/x509/test/unusual_tbs_uid_subject.pem",
    "src/crypto/x509/test/unusual_tbs_v1_not_omitted.pem",
    "src/crypto/x509/test/unusual_tbs_wrong_attribute_order.pem",
    ...
    "src/third_party/wycheproof_testvectors/aes_kwp_test.txt",
    "src/third_party/wycheproof_testvectors/aes_wrap_test.txt",
    "src/third_party/wycheproof_testvectors/chacha20_poly1305_test.txt",
    "src/third_party/wycheproof_testvectors/dsa_2048_224_sha224_p1363_test.txt",
    "src/third_party/wycheproof_testvectors/dsa_2048_224_sha224_test.txt",
    "src/third_party/wycheproof_testvectors/dsa_2048_224_sha256_p1363_test.txt",
    "src/third_party/wycheproof_testvectors/dsa_2048_224_sha256_test.txt",
    "src/third_party/wycheproof_testvectors/dsa_2048_256_sha256_p1363_test.txt",
    "src/third_party/wycheproof_testvectors/dsa_2048_256_sha256_test.txt",
    "src/third_party/wycheproof_testvectors/dsa_3072_256_sha256_p1363_test.txt",
    "src/third_party/wycheproof_testvectors/dsa_3072_256_sha256_test.txt",
    ...
    "src/third_party/wycheproof_testvectors/ed25519_test.txt",
    ...
    "src/third_party/wycheproof_testvectors/mldsa_44_sign_noseed_test.txt",
    "src/third_party/wycheproof_testvectors/mldsa_44_sign_seed_test.txt",
    "src/third_party/wycheproof_testvectors/mldsa_44_verify_test.txt",
    "src/third_party/wycheproof_testvectors/mldsa_65_sign_noseed_test.txt",
    "src/third_party/wycheproof_testvectors/mldsa_65_sign_seed_test.txt",
    "src/third_party/wycheproof_testvectors/mldsa_65_verify_test.txt",
    "src/third_party/wycheproof_testvectors/mldsa_87_sign_noseed_test.txt",
    "src/third_party/wycheproof_testvectors/mldsa_87_sign_seed_test.txt",
    "src/third_party/wycheproof_testvectors/mldsa_87_verify_test.txt",
    "src/third_party/wycheproof_testvectors/mlkem_1024_encaps_test.txt",
    "src/third_party/wycheproof_testvectors/mlkem_1024_keygen_seed_test.txt",
    "src/third_party/wycheproof_testvectors/mlkem_1024_semi_expanded_decaps_test.txt",
    "src/third_party/wycheproof_testvectors/mlkem_1024_test.txt",
    "src/third_party/wycheproof_testvectors/mlkem_768_encaps_test.txt",
    "src/third_party/wycheproof_testvectors/mlkem_768_keygen_seed_test.txt",
    "src/third_party/wycheproof_testvectors/mlkem_768_semi_expanded_decaps_test.txt",
    "src/third_party/wycheproof_testvectors/mlkem_768_test.txt",
    ...
    "src/third_party/wycheproof_testvectors/rsa_pkcs1_1024_sig_gen_test.txt",
    "src/third_party/wycheproof_testvectors/rsa_pkcs1_1536_sig_gen_test.txt",
    "src/third_party/wycheproof_testvectors/rsa_pkcs1_2048_sig_gen_test.txt",
    "src/third_party/wycheproof_testvectors/rsa_pkcs1_2048_test.txt",
    "src/third_party/wycheproof_testvectors/rsa_pkcs1_3072_sig_gen_test.txt",
    "src/third_party/wycheproof_testvectors/rsa_pkcs1_3072_test.txt",
    "src/third_party/wycheproof_testvectors/rsa_pkcs1_4096_sig_gen_test.txt",
    ...
    "src/third_party/wycheproof_testvectors/rsa_signature_4096_sha256_test.txt",
    ...
    "src/third_party/wycheproof_testvectors/rsa_signature_8192_sha256_test.txt",
    "src/third_party/wycheproof_testvectors/rsa_signature_8192_sha384_test.txt",
    "src/third_party/wycheproof_testvectors/rsa_signature_8192_sha512_test.txt",
...
pki_test_data = [
    ...
    "src/pki/testdata/ocsp_unittest/future_response.pem",
    "src/pki/testdata/ocsp_unittest/good_response.pem",
    "src/pki/testdata/ocsp_unittest/good_response_invalid_serial.pem",
    ...
    "src/pki/testdata/ocsp_unittest/invalid_response.pem",
    "src/pki/testdata/ocsp_unittest/invalid_response_data.pem",
    ...
    "src/pki/testdata/ocsp_unittest/multiple_response_good_revoked.pem",
    ...
    "src/pki/testdata/ocsp_unittest/old_response.pem",
    "src/pki/testdata/ocsp_unittest/other_response.pem",
    "src/pki/testdata/ocsp_unittest/produced_early_response.pem",
    "src/pki/testdata/ocsp_unittest/produced_late_response.pem",
    ...
    "src/pki/testdata/ocsp_unittest/stale_response.pem",
    ...
    "src/pki/testdata/path_builder_unittest/mtc_plants04/leaf.pem",
    "src/pki/testdata/path_builder_unittest/mtc_plants04/mtc-ica.pem",
    "src/pki/testdata/path_builder_unittest/mtc_plants04/mtc-leaf-standalone-3cosigners.pem",
    "src/pki/testdata/path_builder_unittest/mtc_plants04/mtc-leaf-standalone-cosigner_wrong_order.pem",
    "src/pki/testdata/path_builder_unittest/mtc_plants04/mtc-leaf-standalone-duplicate_ca_signer.pem",
    "src/pki/testdata/path_builder_unittest/mtc_plants04/mtc-leaf-standalone-no_ca_signer.pem",
    "src/pki/testdata/path_builder_unittest/mtc_plants04/mtc-leaf-standalone.pem",
    "src/pki/testdata/path_builder_unittest/mtc_plants04/mtc-leaf.pem",
    ...
    "src/pki/testdata/verify_signed_data_unittest/mldsa-44-spki-params-null.pem",
    "src/pki/testdata/verify_signed_data_unittest/mldsa-44.pem",
    "src/pki/testdata/verify_signed_data_unittest/mldsa-65-spki-params-null.pem",
    "src/pki/testdata/verify_signed_data_unittest/mldsa-65.pem",
    "src/pki/testdata/verify_signed_data_unittest/mldsa-87-spki-params-null.pem",
    "src/pki/testdata/verify_signed_data_unittest/mldsa-87.pem",
    ...
    "src/pki/testdata/verify_unittest/mldsa-intermediate.pem",
    "src/pki/testdata/verify_unittest/mldsa-leaf.pem",
    "src/pki/testdata/verify_unittest/mldsa-root.pem",
    "src/pki/testdata/verify_unittest/mozilla_roots.der",
    "src/pki/testdata/verify_unittest/mtc-leaf-b.pem",
    "src/pki/testdata/verify_unittest/mtc-leaf-bitflip.pem",
    "src/pki/testdata/verify_unittest/mtc-leaf-c.pem",
    "src/pki/testdata/verify_unittest/mtc-leaf-unused-bit.pem",
    "src/pki/testdata/verify_unittest/mtc-leaf.pem",
